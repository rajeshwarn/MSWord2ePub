...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Ionic Zip Library v1.9.1.6" /productName "Ionic Zip Library v1.9.1.6" > NUL
...
COPY /Y "DotNetZipLib-v1.9.1.6.msha" HelpContentSetup.msha
